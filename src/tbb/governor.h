    ...
    namespace internal
    {
        ...
        public:
            static unsigned default_num_threads()
            {
                ...
                return DefaultNumberOfThreads ? DefaultNumberOfThreads : DefaultNumberOfThreads = AvailableHwConcurrency();
            }
            static size_t default_page_size()
            {
                return DefaultPageSize ? DefaultPageSize : DefaultPageSize = DefaultSystemPageSize();
            }
